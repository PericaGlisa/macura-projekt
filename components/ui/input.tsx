    ...
    return (
      <input
        ...
        className={cn(
          ...
          // Only add focus ring if no custom focus border is specified
          !className?.includes('focus:border') && 'focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2',
          className
        )}
        ref={ref}
        {...props}
